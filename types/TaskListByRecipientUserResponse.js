...
class TaskListByRecipientUserResponse {
    constructor(params = {}) {
        ...
        this.document = new Document_1.Document(document);
    }
}
exports.TaskListByRecipientUserResponse = TaskListByRecipientUserResponse;
